...
function addGeoJsonDataSource(viewer, dataSourceUrl, extrudedHeight, polygonColor) {
  ...
  Promise.all([
    addGeoJsonDataSource(viewer, geoJsonUrl_aoi_child_i, 256 * 8, 'rgba(255, 0, 0)').then(ds => dataSource_aoi_child_i = ds),
    addGeoJsonDataSource(viewer, geoJsonUrl_aoi_child_ii, 256 * 1, 'rgba(0, 255, 0)').then(ds => dataSource_aoi_child_ii = ds),
    addGeoJsonBuildingsDataSource(viewer, geoJsonUrl_buildings, 'rgba(150, 150, 200)').then(ds => dataSource_buildings = ds)
  ]).then(() => {
